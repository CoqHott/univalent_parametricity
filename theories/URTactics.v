...
#[export] Hint Extern 0 (e_fun ?e (e_inv' ?e ?x) = _ ) =>
...
#[export] Hint Extern 0 (e_inv (e_fun ?e) (e_fun ?e ?x) = _ ) =>
etransitivity ; [exact (e_sect (e_fun e) x) | idtac ] : equiv.

#[export] Hint Extern 0 (e_fun ?e (e_inv (e_fun ?e) ?x) = _ ) =>
etransitivity ; [exact (e_retr (e_fun e) x) | idtac ] : equiv.
...
#[export] Hint Extern 0 (?g (?f ?n) = _ ) =>
etransitivity ; [exact (e_sect f n) | idtac ] : equiv.

#[export] Hint Extern 0 (?f (?g ?n) = _ ) =>
etransitivity ; [exact (e_retr f n) | idtac ] : equiv.

#[export] Hint Extern 0 (_ = ?g (?f ?n)) => exact (e_sect f n)^ : equiv.
